...
namespace Demo.Module {
    public class Updater : ModuleUpdater {
        ...
        public override void UpdateDatabaseAfterUpdateSchema() {
            ...
            Document d = ObjectSpace.FindObject<Document>(CriteriaOperator.Parse("Name='How to usse XtraSpellChecker in XAF'"));
            if (d == null) {
                d = ObjectSpace.CreateObject<Document>();
                d.Name = "How to usse XtraSpellChecker in XAF";
                d.Save();
            }
            Article a = ObjectSpace.FindObject<Article>(CriteriaOperator.Parse("Subject='Artiicle 1'"));
            if (a == null) {
                a = ObjectSpace.CreateObject<Article>();
