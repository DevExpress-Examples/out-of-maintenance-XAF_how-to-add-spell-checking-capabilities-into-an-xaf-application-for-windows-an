...
namespace Dennis.Spelling.Win {
    public static class SpellCheckerInitializer {
        ...
        public static void Initialize(SpellChecker spellCheckerCore) {
            ...
            Stream affStream = workAssembly.GetManifestResourceStream("Dennis.Spelling.Win.Dictionaries.English.aff");
            Stream dicStream = workAssembly.GetManifestResourceStream("Dennis.Spelling.Win.Dictionaries.American.xlg");
            Stream alphStream = workAssembly.GetManifestResourceStream("Dennis.Spelling.Win.Dictionaries.EnglishAlphabet.txt");
            ...
            customDictionary.FillAlphabetFromStream(workAssembly.GetManifestResourceStream("Dennis.Spelling.Win.Dictionaries.English.aff"));
            //customDictionary.DictionaryPath = "Dictionaries\\Custom.txt";
            customDictionary.LoadFromStream(workAssembly.GetManifestResourceStream("Dennis.Spelling.Win.Dictionaries.Custom.txt"));
