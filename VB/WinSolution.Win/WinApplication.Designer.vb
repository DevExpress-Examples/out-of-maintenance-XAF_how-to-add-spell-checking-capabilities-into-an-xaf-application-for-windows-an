...
Namespace WinSolution.Win
	Partial Public Class WinSolutionWindowsFormsApplication
		...
		Private Sub InitializeComponent()
			...
			Me.mySpellCheckerModuleModule1 = New MySpellCheckerModule.MySpellCheckerModuleModule()
			CType(Me, System.ComponentModel.ISupportInitialize).BeginInit()
			' 
			' WinSolutionWindowsFormsApplication
			' 
			Me.ApplicationName = "WinSolution"
			Me.ConnectionString = "Integrated Security=SSPI;Pooling=false;Data Source=(local);Initial Cat" & "alog=WinSolution"
			...
			Me.Modules.Add(Me.mySpellCheckerModuleModule1)
'			Me.DatabaseVersionMismatch += New System.EventHandler(Of DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs)(Me.WinSolutionWindowsFormsApplication_DatabaseVersionMismatch);
		...
		Private mySpellCheckerModuleModule1 As MySpellCheckerModule.MySpellCheckerModuleModule
	End Class
End Namespace
